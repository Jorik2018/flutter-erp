...
import 'package:flutter_erp/apps/uber_clone/requests/google_maps_requests.dart';
  ...
  Future<void> sendRequest(String intendedLocation) async {
    try {
      ...
      if (locations.isEmpty) {
        debugPrint('No se encontraron coordenadas para la dirección');
        return;
      }
      ...
      if (_initialPosition == null) {
        debugPrint('La posición inicial todavía no está disponible');
        return;
      }

      final String route = await _googleMapsServices.getRouteCoordinates(
        _initialPosition!,
        destination,
      );
      ...
      debugPrint('Error buscando la dirección: $error');
