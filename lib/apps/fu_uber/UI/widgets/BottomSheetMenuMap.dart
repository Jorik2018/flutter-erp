...
import 'package:flutter_erp/apps/fu_uber/UI/shared/CardSelectionCard.dart';
...
class BottomSheetMapMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final currentRideCreationModel = Provider.of<CurrentRideCreationModel>(context);
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text('checkDestinationOriginForNull'
                ...
                InkResponse(
                  onTap: () {
                    ...
                    Future.delayed(Duration(seconds: 5), () {
                      uiNotifiersModel.searchingRideNotify();
                      navigatorKey.currentState!.pushReplacementNamed(OnGoingRideScreen.route);
                    });
                  },
                  child: Container(
                    height: 100,
