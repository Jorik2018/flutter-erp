...
import 'package:flutter_erp/apps/flutter_verido/Widgets/Assignment4_AppBar.dart';
import 'package:flutter_erp/apps/flutter_verido/Widgets/CheckBoxListTitle.dart';
import 'package:flutter_erp/apps/flutter_verido/Widgets/Drawer.dart';
import 'package:flutter_erp/apps/flutter_verido/Widgets/Heading.dart';
...
class _Assignment4 extends State<Assignment4> {
  ...
  List checkBoxes = [
    {'id': 1, 'label': 'Sale', 'selected': false},
    {'id': 2, 'label': 'Credit', 'selected': false},
    {'id': 3, 'label': 'Refund', 'selected': false},
    {'id': 4, 'label': 'Loan', 'selected': false},
    {'id': 5, 'label': 'Direct Material', 'selected': false},
    {'id': 6, 'label': 'Direct Labour', 'selected': false},
    {'id': 7, 'label': 'Asset', 'selected': false},
    {'id': 8, 'label': 'Other', 'selected': false},
    {'id': 9, 'label': 'Overhead', 'selected': false},
  ];
  List checkBoxes2 = [
    {'id': 1, 'label': 'Consultant Notes Only', 'selected': false},
    {'id': 2, 'label': 'Overdue Only', 'selected': false},
    {'id': 3, 'label': 'Date range', 'selected': false},
  ];
                                ...
                                ToggleButtons(
                                  ...
                                  onPressed: (int index) {
                                    setState(() {
                                      for (
                                        int buttonIndex = 0;
                                        buttonIndex < transactionButtons.length;
                                        buttonIndex++
                                      ) {
