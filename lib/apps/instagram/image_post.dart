...
import 'package:flutter_erp/apps/instagram/LikeAnimation.dart';
...
class _ImagePost extends State<ImagePost> {
  ...
  GestureDetector buildLikeIcon() {
    ...
    return GestureDetector(
      child: Icon(icon, size: 25.0, color: color),
      onTap: () {
        _likePost(postId);
      },
    );
          ...
          showHeart
              ? Positioned(
                  child: Container(
                    width: 100,
                    height: 100,
                    child: Opacity(opacity: 0.85, child: LikeAnimation()),
                  ),
                )
              : Container(),
        ],
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              child: Icon(FontAwesomeIcons.comment.data, size: 25.0),
              onTap: () {
                goToComments(
                  context: context,
                  postId: postId,
        ...
        Row(
          children: <Widget>[
            Container(
              ...
              child: Text("$likeCount likes", style: boldStyle),
            ),
          ],
        ),
        Row(
...
class ImagePostFromId extends StatelessWidget {
  ...
  const ImagePostFromId({super.key, required this.id});

  Future<ImagePost> getImagePost() async {
  ...
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<ImagePost>(
      future: getImagePost(),
      builder: (context, snapshot) {
