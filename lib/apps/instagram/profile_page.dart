...
class _ProfilePage extends State<ProfilePage>
        ...
        builder: (BuildContext context) {
          return Center(
            child: Scaffold(
              ...
              body: ListView(children: <Widget>[Container(child: editPage)]),
            ),
          );
        },
      ),
  ...
  Widget build(BuildContext context) {
    ...
    Container buildProfileFollowButton(app_user.User user) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        app_user.User user = app_user.User.fromDocument(snapshot.data!);
        ...
        builder: (BuildContext context) {
          return Center(
            child: Scaffold(
              ...
              body: ListView(children: <Widget>[Container(child: imagePost)]),
            ),
          );
        },
      ),
