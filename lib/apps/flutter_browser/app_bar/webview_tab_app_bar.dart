...
import 'package:flutter_erp/apps/flutter_browser/app_bar/url_info_popup.dart';
import 'package:flutter_erp/apps/flutter_browser/custom_image.dart';
import 'package:flutter_erp/apps/flutter_browser/main.dart';
import 'package:flutter_erp/apps/flutter_browser/models/browser_model.dart';
import 'package:flutter_erp/apps/flutter_browser/models/favorite_model.dart';
import 'package:flutter_erp/apps/flutter_browser/models/web_archive_model.dart';
import 'package:flutter_erp/apps/flutter_browser/models/webview_model.dart';
import 'package:flutter_erp/apps/flutter_browser/pages/developers/main.dart';
import 'package:flutter_erp/apps/flutter_browser/pages/settings/main.dart';
import 'package:flutter_erp/apps/flutter_browser/tab_popup_menu_actions.dart';
import 'package:flutter_erp/apps/flutter_browser/util.dart';
    ...
    return IconButton(
      ...
      onPressed: () {
        if (_webViewController != null) {
          ...
          _webViewController.loadUrl(urlRequest: URLRequest(url:  WebUri.uri(url),));
        } else {
          addNewTab();
        }
      },
                  ...
                  items: TabPopupMenuActions.choices.map((tabPopupMenuAction) {
                    ...
                    switch (tabPopupMenuAction) {
                      ...
                      case TabPopupMenuActions.NEW_INCOGNITO_TAB:
                        iconData = FontAwesomeIcons.userSecret.data;
                        break;
                    }
