...
import 'package:flutter_erp/apps/flutter_browser/pages/settings/android_settings.dart';
import 'package:flutter_erp/apps/flutter_browser/pages/settings/cross_platform_settings.dart';
import 'package:flutter_erp/apps/flutter_browser/pages/settings/ios_settings.dart';
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(text: "iOS", icon: Icon(FontAwesomeIcons.apple.data)),
            ],
          ),
        ...
        body: TabBarView(
          ...
          children: [CrossPlatformSettings(), AndroidSettings(), IOSSettings()],
        ),
      ),
    );
  }
  ...
  void _popupMenuChoiceAction(String choice) async {
    switch (choice) {
      ...
      case PopupSettingsMenuActions.RESET_WEBVIEW_SETTINGS:
        ...
        var currentWebViewModel = Provider.of<WebViewModel>(
          context,
          listen: false,
        );
