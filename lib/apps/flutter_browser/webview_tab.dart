  ...
  InAppWebView _buildWebView() {
    ...
    return InAppWebView(
        initialUrlRequest: URLRequest(
          url: WebUri.uri(widget.webViewModel.url!)
        ),
...
<body>
    ...
    """, baseUrl: WebUri.uri(errorUrl), androidHistoryUrl: errorUrl);
  ...
  void onShowTab() async {
    ...
    if (widget.webViewModel.needsToCompleteInitialLoad) {
      widget.webViewModel.needsToCompleteInitialLoad = false;
      await widget.webViewModel.webViewController?.loadUrl(urlRequest: URLRequest(url: WebUri.uri(widget.webViewModel.url!)));
