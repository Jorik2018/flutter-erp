import 'package:flutter_erp/apps/day16_shopping/Pages/home_page.dart';
import 'package:flutter_erp/apps/day16_shopping/Pages/not_found.dart';
import 'package:flutter_erp/apps/day16_shopping/Pages/welcome.dart';
...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [inProvider<AppState>(_state)],
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          if (settings.name == Navigator.defaultRouteName) {
            return inPageRoute(
              WelcomePage(),
              RouteSettings(name: WelcomePage.routeName),
            );
          }
