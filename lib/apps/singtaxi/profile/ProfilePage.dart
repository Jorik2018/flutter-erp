                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage("android/assets/cony.jpg"),
                          ),
                    ...
                    Column(
                      children: <Widget>[
                        IconButton(
                          ...
                          onPressed: () {
                            //print("Pressed on a ElevatedButton");
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Icon(Icons.home),
                        SizedBox(width: 5.0),
                        Text('Lives in', style: TextStyle(fontSize: 18.0)),
                        SizedBox(width: 5.0),
                        Text(
                          'Singapore',
                          style: TextStyle(
                    ...
                    Row(
                      children: <Widget>[
                        Icon(Icons.list),
                        SizedBox(width: 5.0),
                        Text('Already Taken', style: TextStyle(fontSize: 18.0)),
                        SizedBox(width: 5.0),
                        Text(
                          '58 DouDou Rides',
                          style: TextStyle(
                      ...
                      children: <Widget>[
                        Expanded(
                          child: MaterialButton(
                            ...
                            child: Text("To be a Driver"),
                            onPressed: () {
                              print("Pressed on a ElevatedButton");
                              Navigator.of(
                                cx,
                              ).pushNamed('/DriverImage'); //route
                            },
                    ...
                    Container(
                      height: 10.0,
                      child: Divider(color: Colors.pink[900]),
                    ),
                  ],
                ),
              ),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 10.0),
                  Text('Delete Profile', style: TextStyle(fontSize: 18.0)),
                ],
              ),
            ),
          ],
