...
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/abstract/shipping_address_repository.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/abstract/user_repository.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/network/network_status.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/cart_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/category_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/payment_method_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/product_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/promo_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/shipping_address_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/user_repository_impl.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/woocommerce/repositories/remote_user_repository.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/woocommerce/repositories/woocommerce_wrapper.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/cart/add_product_to_cart_use_case.dart';
...
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/categories/find_categories_by_filter_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/checkout/checkout_start_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/favorites/add_to_favorites_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/favorites/get_favorite_products_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/favorites/remove_from_favorites_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/products/find_products_by_filter_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/products/get_home_products_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/products/get_product_by_id_use_case.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/promos/get_promos_use_case.dart';
...
void init() {
  ...
  sl.registerLazySingleton<FavoritesRepository>(() => ProductRepositoryImpl());

  sl.registerLazySingleton<PromoRepository>(() => PromoRepositoryImpl());
