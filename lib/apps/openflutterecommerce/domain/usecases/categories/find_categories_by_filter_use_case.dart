...
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/categories/categories_by_filter_params.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/categories/categories_by_filter_result.dart';
...
class FindCategoriesByFilterUseCaseImpl
  ...
  Future<CategoriesByFilterResult> execute(
    CategoriesByFilterParams params,
  ) async {
    try {
