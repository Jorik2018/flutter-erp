...
import 'package:flutter_erp/apps/openflutterecommerce/data/model/shipping_address.dart';
...
import 'package:flutter_erp/apps/openflutterecommerce/domain/usecases/base_use_case.dart';
  ...
  Future<ChekcoutStartResult> execute(ChekcoutStartParams params) async {
    try {
      ...
      return ChekcoutStartResult(
        ...
        shippingAddress: await shippingAddressRepository
            .getShippingAddressList(),
        cartItems: await cartRepository.getCartContent(),
        currentPaymentMethod: await paymentMethodRepository
            .getDefaultPaymentMethod(),
        currentShippingAddress: await shippingAddressRepository
