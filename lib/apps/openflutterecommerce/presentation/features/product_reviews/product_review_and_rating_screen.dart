...
import 'package:flutter_erp/apps/openflutterecommerce/data/model/product_review.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/fake_repos/product_review_repository.dart';
    ...
    return CustomScrollView(
      slivers: <Widget>[
        ...
        BlocProvider<ProductReviewBloc>(
          ...
          child: ProductReviewWrapper(product: widget.product),
        ),
      ],
    );
  }
