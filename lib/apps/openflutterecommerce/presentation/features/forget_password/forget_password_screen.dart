...
import 'package:flutter_erp/apps/openflutterecommerce/domain/entities/validator.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/sign_up/sign_up.dart';
...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen> {
  ...
  void _validateAndSend() {
    ...
    BlocProvider.of<ForgetPasswordBloc>(
      context,
    ).add(ForgetPasswordPressed(emailController.text));
  }
}
