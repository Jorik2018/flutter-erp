...
import 'package:flutter_erp/apps/openflutterecommerce/presentation/widgets/data_driven/cart_tile.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/widgets/data_driven/promo_tile.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/widgets/independent/summary_line.dart';
            ...
            return Stack(
              children: <Widget>[
                SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      OpenFlutterBlockHeader(width: width, title: 'My Cart'),
                      Column(
                        children: buildCartItems(state.cartProducts, bloc),
                      ),
                      Padding(
                        padding: EdgeInsets.only(
                          bottom: AppSizes.sidePadding * 3,
                        ),
                      ),
          ...
          Container(
            ...
            child: OpenFlutterCartTile(
              ...
              onChangeQuantity: ((int quantity) => {
                ...
                if (quantity < 1) {items.remove(items[i])},
              }),
              onAddToFav: () {
