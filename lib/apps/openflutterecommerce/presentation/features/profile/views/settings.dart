...
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/fake_repos/password_repository.dart';
import 'package:flutter_erp/apps/openflutterecommerce/data/repositories/fake_repos/settings_repository.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/password_bloc.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/password_event.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/password_state.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/settings_bloc.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/settings_event.dart';
import 'package:flutter_erp/apps/openflutterecommerce/presentation/features/profile/settings_state.dart';
                    ...
                    children: <Widget>[
                      ...
                      CupertinoSwitch(
                        ...
                        onChanged: (newValue) => settingsBloc.add(
                          UpdateNotifySalesEvent(notifySales: newValue),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: <Widget>[
                      ...
                      CupertinoSwitch(
                        ...
                        onChanged: (newValue) => settingsBloc
                          ..add(
                            UpdateNotifyArrivalsEvent(notifyArrivals: newValue),
                          ),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      CupertinoSwitch(
                        ...
                        onChanged: (newValue) => settingsBloc
                          ..add(
                            UpdateNotifyDeliveryEvent(notifyDelivery: newValue),
                          ),
                      ),
                    ],
                  ),
                      ...
                      onPressed: () => passwordBloc
                        ..add(
                          ChangePasswordEvent(
                            ...
                            repeatNewPassword: _repeatPasswordController.text
                                .trim(),
                          ),
                        ),
                    ),
