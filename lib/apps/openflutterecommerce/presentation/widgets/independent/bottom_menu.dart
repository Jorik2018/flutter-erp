...
import 'package:flutter_erp/apps/openflutterecommerce/config/app_settings.dart';
...
class OpenFlutterBottomMenu extends StatelessWidget {
  ...
  Color colorByIndex(ThemeData theme, int index) {
    return index == menuIndex ? theme.highlightColor : theme.primaryColorLight;
  }
          ...
          onTap: (value) {
            switch (value) {
              ...
              case 3:
                Navigator.pushNamed(
                  context,
                  OpenFlutterEcommerceRoutes.favourites,
                );
                break;
              case 4:
                Navigator.pushNamed(
                  context,
                  OpenFlutterEcommerceRoutes.profile,
                );
                break;
            }
          },
