      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Flexible(flex: 5, child: _buildBar(context, starQuantity)),
            Flexible(flex: 2, child: _buildCounter(context, starQuantity)),
          ],
        ),
      ),
    );
      ...
      child: Align(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Flexible(
              flex: _calculateTransparentBarWithByQuantity(
