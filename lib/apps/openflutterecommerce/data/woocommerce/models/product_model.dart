...
import 'package:flutter_erp/apps/openflutterecommerce/domain/entities/hashtag/hashtag_entity.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/entities/product/product_category_entity.dart';
import 'package:flutter_erp/apps/openflutterecommerce/domain/entities/product/product_entity.dart';
  ...
  static List<HashTagEntity> _getHashTagsFromJson(Map<String, dynamic> json) {
    ...
    if (json['tags'] != null) {
      for (var hashTag in json['tags']) {
        tags.add(
          HashTagEntity(id: hashTag['id'] ?? 0, title: hashTag['name'] ?? ''),
        );
      }
    }
    return tags;
