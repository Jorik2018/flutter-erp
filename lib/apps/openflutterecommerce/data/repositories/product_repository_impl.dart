...
import 'package:flutter_erp/apps/openflutterecommerce/data/local/local_product_repository.dart';
...
class ProductRepositoryImpl extends ProductRepository with FavoritesRepository {
  ...
  Future<List<Product>> getProducts({
    ...
    try {
      ...
      products.forEach(
        (product) => {
          dataStorage.products.add(product.favorite(checkFavorite(product.id))),
        },
      );
  ...
  Future<List<FavoriteProduct>> removeFromFavorites(
    ...
    dataStorage.favProducts.removeWhere(
      (product) =>
