...
import 'package:flutter_erp/apps/flutterecommerceapp/screen/home_screen.dart';
 ...
 Widget _createForm(){
  ...
  Widget _googleButtonWidget() {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Icon(FontAwesomeIcons.google.data,color: Colors.red,),
          SizedBox(width: 5,),
  ...
  Widget _facebookButtonWidget() {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Icon(FontAwesomeIcons.facebookF.data,color: Colors.blue,),
          SizedBox(width: 5,),
