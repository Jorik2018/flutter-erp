...
import 'package:flutter_erp/apps/flutter_finance_app_ui/common/current_screen_index.dart';
  ...
  Widget _buildBottomNavigationBarPortrait() {
    return BottomNavigationBar(
      items: [
        ...
        BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.commentDots.data)),
