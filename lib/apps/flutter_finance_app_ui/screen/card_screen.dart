...
import 'package:flutter_erp/apps/flutter_finance_app_ui/custom_widgets/card_widget.dart';
import 'package:flutter_erp/apps/flutter_finance_app_ui/custom_widgets/transaction_list_widget.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 3, right: 15, top: 30),
            child: Container(
              height: 175,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                Column(
                  children: List.generate(Constants.titleList.length, (index) {
