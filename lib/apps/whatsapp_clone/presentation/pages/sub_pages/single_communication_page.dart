      ...
      children: [
        ConstrainedBox(
          ...
          child: Container(
            ...
            /**Error: The method 'Bubble' isn't defined for the type '_SingleCommunicationPageState'.
Try correcting the name to the name of an existing method, or defining a method named 'Bubble'. */
            child: BubbleSpecialThree(
    text: text,
    color: color,
    tail: true,
    isSender: true, // o false según usuario
    textStyle: TextStyle(
      fontSize: 18,
    ),
  ), /*Bubble(
