...
import 'package:flutter_erp/apps/f_groceries/checkout_screen.dart';
...
class item_details extends State<Item_Details> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle descriptionStyle = theme.textTheme.headlineSmall!;
    IconData _backIcon() {
                          ...
                          children: <Widget>[
                            Container(
                              child: CarouselSlider(
                                items: [
                                  Image.asset('images/apple.jpg', fit: BoxFit.scaleDown),
                                  Image.asset('images/tomato.jpg', fit: BoxFit.scaleDown),
                                  Image.asset('images/lemons.jpg', fit: BoxFit.scaleDown),
                                  Image.asset('images/kiwi.jpg', fit: BoxFit.scaleDown),
                                  Image.asset('images/guava.jpg', fit: BoxFit.scaleDown),
                                  Image.asset('images/grapes.jpg', fit: BoxFit.scaleDown),
                                ],
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Container(margin: EdgeInsets.only(right: 2.0)),
                              IconButton(
                                icon: Icon(
                                  _sub_icon(),
                                  color: Colors.amber.shade500,
