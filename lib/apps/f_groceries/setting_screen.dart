...
import 'package:flutter_erp/apps/f_groceries/item_details.dart';
...
class Setting_Screen extends StatefulWidget {
  ...
  Setting_Screen({Key? key, required this.toolbarname}) : super(key: key);
...
class Setting extends State<Setting_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dialogTextStyle = theme.textTheme.headlineSmall!.copyWith(
