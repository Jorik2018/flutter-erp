  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(children: <Widget>[_headerWidget(), _bodyContent()]),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 15),
          widget.popularCitiesModel.activeFriends == null
              ? Text(
              ...
              : Text(""),
          SizedBox(height: 15),
          widget.popularCitiesModel.hotelRent == null
              ? Text(
