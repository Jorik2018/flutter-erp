import 'package:flutter_erp/apps/pak_tourism/model/friend_model.dart';
import 'package:flutter_erp/apps/pak_tourism/model/my_trip_model.dart';
import 'package:flutter_erp/apps/pak_tourism/model/popular_cities_model.dart';
import 'package:flutter_erp/apps/pak_tourism/model/trendingModel.dart';
...
class TravelRepository {
  static List<PopularCitiesModel> popularCities = [
    ...
    PopularCitiesModel(
      caption:
          "Quetta, formerly known as Shalkot, is the provincial capital and largest city of the Pakistani province of Balochistan. It is also the 10th largest city in Pakistan. It was largely destroyed in the 1935 Quetta earthquake, but was rebuilt and has a population of 1,001,205 according to the census of 2017."
          "Area: 178 km²",
      name: "Quetta",
    ...
    PopularCitiesModel(
      caption:
          "Hyderabad is a city and capital of Hyderabad Division in the Sindh province of Pakistan. It is the second-largest city in Sindh, and the eight-largest in Pakistan."
          "Area: 292 km²",
      name: "Hyderabad",
    ...
    PopularCitiesModel(
      caption:
          "Abbottabad is the capital city of Abbottabad District in the Hazara region of eastern Khyber Pakhtunkhwa, Pakistan. It is the 40th largest city in Pakistan and fourth largest in the province of Khyber Pakhtunkhwa by population."
          "Area: 18,013 km²",
      name: "Abbottabad",
    ...
    PopularCitiesModel(
      caption:
          "Rahim Yar Khan is a city in Punjab province of Pakistan. It is the 17th largest city of Pakistan by population. It is the capital of Rahim Yar Khan District and Rahim Yar Khan Tehsil. The administration of the city is subdivided into nine Union Councils."
          "Area: 4,141 km²",
      name: "Rahim Yar Khan",
    ...
    PopularCitiesModel(
      caption:
          "Gwadar is a port city on the southwestern coast of Balochistan, Pakistan. The city is located on the shores of the Arabian Sea opposite Oman. Gwadar It is the 100th largest city of Pakistan, according to 2017 census it was an overseas possession of Oman from 1783 to 1958."
          "Area: 12,637 km2",
      name: "Gwader",
    ...
    PopularCitiesModel(
      caption:
          "Thatta is a city in the Pakistani province of Sindh. Thatta was the medieval capital of Sindh, and served as the seat of power for three successive dynasties. Thatta's historic significance has yielded several monuments in and around the city"
          "Area: 3823 km²",
      name: "Thatta",
    ...
    PopularCitiesModel(
      caption:
          "Gujranwala is a city and capital of Gujranwala Division located in Punjab, Pakistan. It is also known as City of Wrestlers and is quite famous for its food. The city is Pakistan's 5th most-populous metropolitan area, as well as 5th most populous city proper."
          "Area: 240 km²",
      name: "Gujrawala",
    ...
    PopularCitiesModel(
      caption:
          "Sialkot is a city in Punjab, Pakistan. It is the capital city of Sialkot District. It is Pakistan's 13th most populous city and is located in north-east Punjab—one of Pakistan's most industrialised regions."
          "Area: 19 km²",
      name: "Sailkot",
    ...
    PopularCitiesModel(
      caption:
          "Sukkur is a city in the Pakistani province of Sindh along the western bank of the Indus River, directly across from the historic city of Rohri. Sukkur is the third largest city in Sindh after Karachi and Hyderabad, and 14th largest city of Pakistan by population."
          "Area: 300 km²",
      name: "Sukkur",
    ...
    PopularCitiesModel(
      caption:
          "Attock, formerly known as Campbellpur, is a historical city located in the north of Pakistan's Punjab Province, not far from the country's capital Islamabad. It is the headquarters of the Attock District and is 61st largest city of Pakistan by population."
          "Area: 6,857 km²",
      name: "Attock",
    ...
    PopularCitiesModel(
      caption:
          "Kasur is a city to south of Lahore, in the Pakistani province of Punjab. The city serves as the headquarters of Kasur District. Kasur is the 24th largest city of Pakistan by population. It is also known for being the burial place of the 17th-century Sufi-poet Bulleh Shah"
          "Area: 3,995 km²",
      name: "Kasur",
    ...
    PopularCitiesModel(
      caption:
          "Dera Ghazi Khan, abbreviated as D. G. Khan, is a city in the Punjab province of Pakistan. It is the 19th largest city of Pakistan by population. It is the headquarters of the Dera Ghazi Khan District and Dera Ghazi Khan Division."
          "Area:  70 km²",
    ...
    PopularCitiesModel(
      caption:
          "Kohat, is a city in the Khyber Pakhtunkhwa province of Pakistan which serves as the capital of the Kohat District. The city is regarded as a centre of the Bangash tribe of Pashtuns, who have lived in the region since the late 15th century."
          "Area:  2545 sq. kms",
      name: "Kohat",
    ...
    PopularCitiesModel(
      caption:
          "Nawabshah is a city and headquarters of the Shaheed Benazirabad District of Sindh province, Pakistan. This city is situated in middle of Sindh province. It is the 27th largest city in Pakistan."
          "Area: 4,239 km²",
      name: "Nawabshah",
    ...
    PopularCitiesModel(
      caption:
          "Chaman is a city and recently claimed as a new district of Balochistan named Chaman District as it was earlier a part of district Qila Abdullah District located on the Afghanistan-Pakistan border. It is the capital of Chaman District, Balochistan, Pakistan"
          "Area: 5,264 km2",
      name: "Chaman",
    ...
    PopularCitiesModel(
      caption:
          "Ziarat is a city in the Ziarat District situated in the Balochistan. It is 130 kilometres from the capital city of Eastern Balochistan Quetta."
          "Area: 1,489 km²",
      name: "Ziarat",
  ...
  static List<PopularCitiesModel> beautiful_places = [
    ...
    PopularCitiesModel(
      ...
      name: "Skardu Valley",
      caption:
          "The Skardu Valley is located in Gilgit-Baltistan, Pakistan. The valley is about 10 km wide and 40 km long. It is at the confluence of the Shigar River and Indus River. It surrounded by the large Karakoram Range. With the nearby lakes and mountains, it is an important tourist location in Pakistan"
    ...
    PopularCitiesModel(
      ...
      caption:
          "The Deosai National Park is a high-altitude alpine plain and National Park located in between Skardu, Astore and Kharmang district in Gilgit Baltistan. Most of the area falls in Skardu district. ",
    ...
    PopularCitiesModel(
      ...
      name: "Kaplu",
      caption:
          "Khaplu, also spelt Khapalu, is a city that serves as the administrative capital of the Ghanche District of Gilgit-Baltistan, in northern Pakistan. Lying 103 km east of the city of Skardu, it was the second-largest kingdom in old Baltistan of the Yabgo dynasty"
    ...
    PopularCitiesModel(
      ...
      name: "Nalter Valley",
      caption:
          "Naltar is a valley situated near the city of Gilgit in Gilgit−Baltistan, Pakistan. Naltar is about 34 kilometres from Gilgit. Naltar is a forested region known for its dramatic mountain scenery. Naltar valley is also famous for the three lakes-Strangi Lake, Blue Lake and Bodlok Lake."
    ...
    PopularCitiesModel(
      ...
      name: "Shandar Pass",
      caption:
          "Shandur Pass is a pass located in District Ghizer. It is often called 'Roof of the World'. During the annual 'Shandur Polo Festival,' there are polo matches played in Shandur Polo Ground on Shandur Top, between the teams of Chitral District and Gilgit-Baltistan Province."
    ...
    PopularCitiesModel(
      ...
      name: "Moola Chotok",
      caption:
          "Moola Chotok is a hidden ravine located in the middle of the Khuzdar District in the southern province of Balochistan, Pakistan. It is situated approximately 105 kilometres north-east of Khuzdar at an elevation of 1,237 metres."
    ...
    PopularCitiesModel(
      ...
      name: "Miranjani",
      caption:
          " It is located in the Namli Maira area, in Ayubia National Park, 80 kilometres north of Islamabad in the western Himalayan range"
    ...
    PopularCitiesModel(
      ...
      name: "Kumrat Valley",
      caption:
          "Kumrat is a valley in the Upper Dir District of Khyber Pakhtunkhwa the Province of Pakistan. Kumrat Valley is located about 2 hours away from the town of Thal. It is one of the beautiful valleys of Khyber Pakhtunkhwa"
    ...
    PopularCitiesModel(
      ...
      name: "K2",
      caption:
          "K2, at 8,611 metres above sea level, is the second-highest mountain on Earth, after Mount Everest. It lies in the Karakoram range, in part in the Gilgit-Baltistan region of Pakistan-administered Kashmir ",
      hotelRent: "Camping Place",
    ),
    PopularCitiesModel(
      ...
      name: "Nagan Parbat",
      caption:
          "Nanga Parbat, known locally as Diamer, is the ninth-highest mountain on Earth, its summit at 8,126 m above sea level",
    ...
    PopularCitiesModel(
      ...
      name: "Mall Road",
      caption:
          "Shahrah-e-Quaid-e-Azam, formerly known as The Mall or Mall Road, is a major road in Lahore, Punjab, Pakistan. The road was laid out during the British Raj on a route leading to the Governor's House, lined on both sides with Mughal shrines and kilns"
    ...
    PopularCitiesModel(
      ...
      name: "Pir Chinasi",
      caption:
          "Pir Chinasi is a shrine and a tourist destination located about 30 kilometers east of Muzaffarabad, the capital city of Azad Kashmir administered by Pakistan. It is located on the top of hills at the height of 2,900 metres",
    ...
    PopularCitiesModel(
      ...
      name: "Darkot Pass",
      caption:
          "Darkot pass is a high mountain pass that connects Baroghil Valley in Chitral and Rawat valley of Ghizer District in Gilgit, Pakistan. It is also known as Darkut. The pass is about 10 miles to the east of Koyo Zom, the highest peak in Ghizer District.",
      hotelRent: "Camping place",
    ),
    PopularCitiesModel(
    ...
    PopularCitiesModel(
      ...
      name: " Mukeshpuri",
      caption:
          "Mukeshpuri is a 2,800-metre-high mountain in the Nathia Gali Hills, in the Abbottabad District of the Khyber Pakhtunkhwa province in northern Pakistan. It is 90 kilometres north of Islamabad, just above Dunga Gali in the Nathia Gali area of Ayubia National Park"
    ...
    PopularCitiesModel(
      ...
      name: "Kund Malir:",
      caption:
          "Kund Malir' is a beach in Balochistan, Pakistan located in Hingol National Park, about 150 kilometres from Zero-Point on Makran Coastal Highway. It is located 236.8 kilometres west of Karachi, the largest city of Pakistan. The drive between Kund Malir and Ormara is considered to be scenic"
    ...
    PopularCitiesModel(
      ...
      caption:
          "Soon Sakaser is a valley situated in northern Punjab, Pakistan. Soon Sakaser is situated at the juncture of Mianwali, Khushab, and Chakwal districts"
          "",
      hotelRent: "Camping Place",
    ),
    PopularCitiesModel(
      ...
      name: "Changa Manga",
      caption:
          "Changa Manga is about 70 km from Lahore where the attractions include an artificial lake and a small railway that runs through its jungle."
    ...
    PopularCitiesModel(image: "assets/", name: "", caption: "", hotelRent: ""),
  ];
  //FIXME: replace data
