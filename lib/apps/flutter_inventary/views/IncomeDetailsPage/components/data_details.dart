...
import 'package:flutter_erp/apps/flutter_inventary/utils/main.dart';
//import 'package:flutter_erp/apps/flutter_inventary/controller/httpRequest/main.dart';
...
class _DataDetails extends State<DataDetails> {
  ...
  Widget build(BuildContext context) {
              ...
              Flexible(
                child: TextFormField(
                  ...
                  onSaved: (String? value) {
                    data["patrimonial"] = value == null || value == ""
                        ? "S/C"
                        : value;
                  },
    ...
    final data_details = Container(
      margin: const EdgeInsets.only(top: 20.00, right: 20.0, left: 20.0),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Text("REGISTRO DE DETALLES"),
          details_form,
          Expanded(
            child: Padding(
