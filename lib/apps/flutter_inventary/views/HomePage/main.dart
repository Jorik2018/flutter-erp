...
class _HomePage extends State<HomePage> {
  ...
  void _getDistricts(int page) {
    HttpClient.get('/$page/20').then((response) {
            ...
            Expanded(
              child: PaginatedDataTable2(
                ...
                columns: [
                  ...
                  DataColumn(
                    label: Center(
                      child: Text('Organo o Unidad Organica', style: ts),
                    ),
                  ),
                  DataColumn(
  ...
  DataRow? getRow(int index) {
    return DataRow(
      cells: [
        ...
        DataCell(
          Text(
            _data[index]["dependence"] != null
                ? _data[index]["dependence"]
                : "",
          ),
        ),
        DataCell(
          Text(_data[index]["date"] != null ? _data[index]["date"] : ""),
        ),
        DataCell(
          Center(
