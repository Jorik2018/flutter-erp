...
import 'package:flutter_erp/apps/flutter_pma/screen/fragment/home_fragment.dart';
    ...
    for (var i = 0; i < drawerItems.length; i++) {
      ...
      drawerOptions.add(
        new Column(
          children: <Widget>[
            new ListTile(
              leading: Icon(d.icon, color: Colors.blue),
              title: Text(
                d.title,
                style: TextStyle(
                  color: Colors.blue,
            ...
            new Divider(color: Colors.blue, height: 2.0),
          ],
        ),
      );
    }
