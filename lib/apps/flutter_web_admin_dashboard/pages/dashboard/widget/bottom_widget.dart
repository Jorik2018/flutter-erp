...
import 'package:flutter_erp/apps/flutter_web_admin_dashboard/common/app_responsive.dart';
import 'package:flutter_erp/apps/flutter_web_admin_dashboard/pages/widget/chart/line_chart.dart';
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [Color(0xff19315d), Color(0xff19253f)],
                    ),
                  ),
                  child: Stack(
                    children: [
              ...
              child: (!AppResponsive.isMobile(context))
                  ? Row(
                      ...
                      children: [
                        ...
                        /// List
                        Expanded(child: _textGraphValute()),
                      ],
                    )
                  : Column(
                      mainAxisSize: MainAxisSize.min,
      ...
      BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: 3, // ❗ antes era "y"
            width: 10,
            rodStackItems: [BarChartRodStackItem(0, 3, Colors.pink)],
            borderRadius: BorderRadius.zero,
          ),
          BarChartRodData(
            toY: 8,
            width: 10,
            rodStackItems: [BarChartRodStackItem(0, 8, Colors.blue)],
            borderRadius: BorderRadius.zero,
          ),
          BarChartRodData(
            toY: 4,
            width: 10,
            rodStackItems: [BarChartRodStackItem(0, 4, AppColors.yellow)],
            borderRadius: BorderRadius.zero,
          ),
          BarChartRodData(
            toY: 9,
            width: 10,
            rodStackItems: [BarChartRodStackItem(0, 9, AppColors.slackBgColor)],
            borderRadius: BorderRadius.zero,
          ),
        ],
      ),
