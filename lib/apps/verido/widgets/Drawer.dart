...
import 'package:flutter_erp/apps/verido/router.dart';
...
var menus2 = [
  ...
  {'name': 'logout', 'icon': Icons.logout, 'route': '/', 'active': false},
];
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    child: ListTile(
                      ...
                      onTap: () {
                        context.push(
                          '${Configs.path_parent}${widget.menuList[index]['route']}',
                        );
                      },
                    ),
                  );
