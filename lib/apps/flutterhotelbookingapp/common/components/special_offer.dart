...
import 'package:flutter_erp/apps/flutterhotelbookingapp/model/deal.dart';
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            SizedBox(width: 10),
            Text("Special Offer", style: kHeadingextStyle),
            Spacer(),
            Text(
              "See All",
...
class SpecialOfferList extends StatelessWidget {
    ...
    dealModels.forEach((dealModel) {
      Widget element = Container(
        ...
        child: GestureDetector(
          child: SpecialOfferCard(dealModel: dealModel),
          onTap: () {},
        ),
      );
      list.add(element);
  ...
  @override
  Widget build(BuildContext context) {
    return Section(horizontalList: this.generateList(context));
  }
}
...
class SpecialOfferCard extends StatefulWidget {
  ...
  SpecialOfferCard({required this.dealModel});
