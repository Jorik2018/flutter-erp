...
class StringUtils {
  ...
  static String formatYr(int yr) {
    if (yr == 0) yr = 1;
    return supplant(
      /**error: The argument type 'String Function(Object, Object)' can't be assigned to the parameter type 'String'. dartargument_type_not_assignable
AppLocalizations get $strings
Type: AppLocalizations */
      $strings.yearFormat(yr.abs().toString(),getYrSuffix(yr)),
      {
