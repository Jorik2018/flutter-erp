...
Try changing the name to the name of an existing class, or creating a class with the name 'DecoderCallback'. */
  ImageStreamCompleter load(Object key, ImageDecoderCallback decode) {
    // ignore: deprecated_member_use
    /**error:The method 'load' isn't defined for the type 'ImageProvider'.
