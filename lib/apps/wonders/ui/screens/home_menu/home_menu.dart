...
import 'package:flutter_erp/apps/wonders/ui/screens/home_menu/about_dialog_content.dart';
...
class HomeMenu extends StatelessWidget {
    ...
    return Stack(
      children: [
        ...
        AppBackdrop(
          strength: .5,
          child: Container(
            color: $styles.colors.greyStrong.withValues(alpha:.7),
          ),
        ),
  ...
  Widget _buildBottomBtns(BuildContext context) {
    return SeparatedColumn(
      /**error:The method 'animate' isn't defined for the type 'Divider'.
Try correcting the name to the name of an existing method, or defining a method named 'animate'. */
      separatorBuilder: () => Divider(thickness: 1.5, height: 1).animate().scale(
            duration: $styles.times.slow,
            /**The getter 'ms' isn't defined for the type 'int'.
Try importing the library that defines 'ms', correcting the name to the name of an existing getter, or defining a getter or field named 'ms'. */
