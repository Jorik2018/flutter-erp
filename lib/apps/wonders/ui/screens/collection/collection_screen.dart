...
/**error:A value of type 'ValueNotifier<Map<String, int>>' can't be assigned to a variable of type 'Map<String, int>'.
Try changing the type of the variable, or casting the right-hand type to 'Map<String, int>'. */
