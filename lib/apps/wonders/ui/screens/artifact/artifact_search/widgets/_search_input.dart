...
class _SearchInput extends StatelessWidget {
  ...
  Widget _buildSuggestionTitle(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(border: Border(bottom: BorderSide(color: $styles.colors.greyStrong.withValues(alpha:0.1)))),
      child: CenterLeft(
        child: Text(
        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: captionColor.withValues(alpha:0.5)),
