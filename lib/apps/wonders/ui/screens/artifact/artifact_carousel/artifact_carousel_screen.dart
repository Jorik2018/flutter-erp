...
import 'package:flutter_erp/apps/wonders/logic/data/highlight_data.dart';
import 'package:flutter_erp/apps/wonders/ui/common/controls/app_page_indicator.dart';
import 'package:flutter_erp/apps/wonders/ui/common/controls/simple_header.dart';
import 'package:flutter_erp/apps/wonders/ui/common/controls/gap.dart';
import 'package:flutter_erp/apps/wonders/ui/widgets/layout/bottom_center.dart';
...
class _ArtifactScreenState extends State<ArtifactCarouselScreen> {
  ...
  Widget _buildScreen(BuildContext context, _) {
    ...
    final double backdropHeight = math.min(context.size!.height * 0.65, _maxElementHeight);
          ...
          children: [
            ...
            Expanded(
              child: Stack(children: [
                ...
                /**error:The method 'BottomCenter' isn't defined for the type '_ArtifactScreenState'.
Try correcting the name to the name of an existing method, or defining a method named 'BottomCenter'. */
                BottomCenter(
                  child: Container(
                    width: backdropWidth,
