...
class CollectibleFoundScreen extends StatelessWidget {
  ...
  Widget _buildIntro(BuildContext context) {
    ...
    return Stack(children: [
      ...
      Center(
        ...
        ).animate().scale(begin: const Offset(1.5, 1.5),
  end: const Offset(3, 3), curve: Curves.easeInExpo, delay: t, duration: t * 3).fadeOut(),
      )
    ]);
  }
  ...
  Widget _buildImage(BuildContext context) {
    ...
    return AppImage(image: imageProvider, scale: 1.0)
        ...
        .scale(begin:const Offset(.3, .3) , duration: t * 2, curve: Curves.easeOutExpo, alignment: Alignment(0, 0.7));
  }
  ...
  Widget _buildRibbon(BuildContext context) {
    ...
    return _AnimatedRibbon($strings.collectibleFoundTitleArtifactDiscovered.toUpperCase())
        .animate()
        .scale(begin: const Offset(.3, .3), duration: t * 2, curve: Curves.easeOutExpo, alignment: Alignment(0, -1));
  }
