...
class WonderDetailsTabMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /**The getter 'mq' isn't defined for the type 'BuildContext'.
Try importing the library that defines 'mq', correcting the name to the name of an existing getter, or defining a getter or field named 'mq'. */
    bottomPadding = max(MediaQuery.of(context).padding.bottom, $styles.insets.xs * 1.5);
    return Stack(
      children: [
        //Background
        Positioned.fill(
