...
class _CollapsingPullQuoteImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final collapseStartPx = context.size!.height * 1;
    final collapseEndPx = context.size!.height * .35;
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.only(
                      topRight: Radius.circular(context.size!.width / 2),
                      topLeft: Radius.circular(context.size!.width / 2),
                    ),
                  ),
                ),
