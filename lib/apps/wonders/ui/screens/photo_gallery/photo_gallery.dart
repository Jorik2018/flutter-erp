...
import 'package:flutter_erp/apps/wonders/ui/common/controls/eight_way_swipe_detector.dart';
...
import 'package:flutter_erp/apps/wonders/ui/common/unsplash_photo.dart';
        ...
        CupertinoPageRoute(
          builder: (_) {
            final urls = _photoIds.value.map((e) {
              return UnsplashPhotoData.getSelfHostedUrl(
                e,
                UnsplashPhotoSize.med,
              );
            }).toList();
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<String>>(
      ...
      builder: (_, value, __) {
        ...
        Size imgSize =
            (widget.imageSize ??
                Size(context.size!.width * .66, context.size!.height * .5)) *
            _scale;
