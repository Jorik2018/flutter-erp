...
import 'package:flutter_erp/apps/wonders/ui/common/fade_color_transition.dart';
import 'package:flutter_erp/apps/wonders/ui/wonder_illustrations/common/paint_textures.dart';
import 'package:flutter_erp/apps/wonders/ui/wonder_illustrations/common/wonder_hero.dart';
import 'package:flutter_erp/apps/wonders/ui/wonder_illustrations/common/wonder_illustration_builder.dart';
      ...
      Align(
        ...
        child: FractionalTranslation(
          ...
          child: WonderHero(
            ...
            child: Image.asset(
              '$assetPath/sun.png',
              cacheWidth: context.size!.width.round() * 2,
            ...
            child: Transform.scale(
              ...
              child: FractionalTranslation(
                ...
                child: Image.asset('$assetPath/foreground-right.png',
                    opacity: anim, cacheWidth: context.size!.width.round() * 3),
              ),
            ),
          ),
        ),
