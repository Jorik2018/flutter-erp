...
class Homepage extends State<Home> {
  ...
  Future sendImage() async {
    if (imageFile != null) {
      ...
      final apiURL = 'https://pcc.edu.pk/ws/file_upload.php';
      HttpClient.send(apiURL, body: {"image": base64Image, "name": imageName})
          .then((res) {
            var result = res.body is String ? jsonDecode(res.body!) : res.body;
            print(result);
            setState(() {
                            ...
                            return CupertinoAlertDialog(
                              ...
                              actions: [
                                TextButton(
                                  ...
                                  child: Icon(Icons.photo_camera, size: 22),
                                ),
                                TextButton(
                                  onPressed: () async {
                                    onImageButtonPressed(
