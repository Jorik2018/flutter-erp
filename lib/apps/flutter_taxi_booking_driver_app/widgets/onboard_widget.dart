...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/wave_animation_widget.dart';
...
class _OnboardWidgetState extends State<OnboardWidget> {
  ...
  late PageController _controllerTitle;
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: Theme.of(
                          context,
                        ).textTheme.titleMedium!.copyWith(color: kAccentColor),
                      ),
                    ),
                    Container(
