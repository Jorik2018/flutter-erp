...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/rating_line_widget.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 5),
                RartingLineWidget(myWidth: getWidth(455)),
                SizedBox(height: 15),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                ...
                SizedBox(height: 5),
                RartingLineWidget(myWidth: getWidth(200)),
                SizedBox(height: 15),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                ...
                SizedBox(height: 5),
                RartingLineWidget(myWidth: getWidth(300)),
                SizedBox(height: 15),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                ...
                SizedBox(height: 5),
                RartingLineWidget(myWidth: getWidth(150)),
                SizedBox(height: 15),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
