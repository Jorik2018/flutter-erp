...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/animation_rating_widget.dart';

class RartingLineWidget extends StatefulWidget {
  var myWidth;
  RartingLineWidget({Key? key, this.myWidth}) : super(key: key);
  @override
