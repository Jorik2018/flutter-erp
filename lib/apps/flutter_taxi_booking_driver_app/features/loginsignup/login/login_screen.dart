...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/country_selection_textfield_widget.dart';
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/fab_button.dart';
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/password_textfield.dart';
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/wavy_header_widget.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (_) => LoginBloc(), child: Login());
  }
}
      ...
      child: Column(
        ...
        children: <Widget>[
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                FABButton(
                  ...
                  onTap: () {
                    if (_mobileCntrl.text.isNotEmpty) {
                      if (_passCntrl.text.isNotEmpty) {
                  ...
                  icon: Icon(Viiticons.next_arrow, color: Colors.white),
                ),
              ],
            ),
          ),
          ...
          Center(
            child: GestureDetector(
              onTap: () {
                loginBloc.add(LoginWithFaceidEvent());
              },
              child: Text(
                "Login with Face ID",
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: "Sign Up",
                      style: Theme.of(context).textTheme.headlineSmall!
                          .copyWith(color: kAccentColor, fontSize: 18),
                    ),
                  ],
                ),
              ),
