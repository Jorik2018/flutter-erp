...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/date_picker_widget.dart';
...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/square_textfield_widget.dart';
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Stack(
                children: <Widget>[
                  const SizedBox(height: 128, width: 135),
              ...
              Row(
                ...
                children: <Widget>[
                  Checkbox(
                    value: _isAcceptViitTeen,
                    activeColor: Colors.grey,
                    onChanged: (bool? value) {
                      print(value);
                      setState(() {
                        _isAcceptViitTeen = value!;
                      });
                    },
              ...
              Row(
                children: <Widget>[
                  Checkbox(
                    value: _isRideForHandicap,
                    activeColor: Colors.grey,
                    onChanged: (bool? value) {
                      print(value);
                      setState(() {
                        _isRideForHandicap = value!;
                      });
                    },
                    checkColor: Color(0xFFFFFFFF),
                    tristate: false,
