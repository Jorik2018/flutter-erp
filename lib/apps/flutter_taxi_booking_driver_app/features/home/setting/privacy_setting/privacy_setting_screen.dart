...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/privacy_widget.dart';
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: 10),
                    Divider(height: 4, color: Color(0XFFE8E4E4)),
                    SizedBox(height: 10),
                    PrivacyWidget(
                    ...
                    Divider(height: 4, color: Color(0XFFE8E4E4)),
                    SizedBox(height: 10),
                    PrivacyWidget(myTitle: "Vitt Teen ", mydeisc: ""),
                    SizedBox(height: 10),
                    Divider(height: 4, color: Color(0XFFE8E4E4)),
                    SizedBox(height: 10),
                    PrivacyWidget(myTitle: "Vitt Access ", mydeisc: ""),
                  ],
                ),
              ),
            ],
