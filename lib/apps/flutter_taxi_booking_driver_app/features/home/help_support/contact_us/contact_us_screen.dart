...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/multiline_textfield_widget.dart';
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: 15),
                    Text("Instant Contact", style: TextStyle(fontSize: 18)),
                    SizedBox(height: 15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Icon(Icons.mail, size: 20, color: kTextLoginfaceid),
                        SizedBox(width: 6),
                        Text(
                          "viit.info@viit.com",
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Color(0xff8C8C8F), width: 1),
                      ),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
