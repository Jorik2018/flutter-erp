...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/upcoming_ride_itmelayout_widget.dart';
...
class _State extends State<CanceledRideScreen> {
  var arryLength = 1;
  List<String> rideTimes = ["Dec 2, 2019 8:25 AM"];
  List<String> rideType = ["Vitt S"];
  List<String> pickUpAdd = ["38, rue des Nations"];
  List<String> dropUpAdd = ["54, rue du Gue Jacquet"];
  List<String> amount = ["€ 43.10", "€ 33.60", "€ 12.14"];
  List<String> image = ["assets/mapiamge.jpeg"];
