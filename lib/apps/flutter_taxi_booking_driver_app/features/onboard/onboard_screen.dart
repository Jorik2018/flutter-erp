...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/widgets/onboard_widget.dart';
...
class OnBoardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => OnboardBloc(), child: OnBoard());
  }
}
              ...
              builder: (blocContext, state) {
                ...
                if (state is InitialOnboardState) {
                  ...
                  return OnboardWidget(
                    ...
                    myOnSkipPressed: () {
                      print("Press Skip");
                      onBoardBloc.add(GoToLoginEvent());
                    },
                    myOnNextPressed: () {
                      print("Press Next");
                      onBoardBloc.add(NextEvent());
