...
import 'package:flutter_erp/apps/flutter_taxi_booking_driver_app/features/landing/landing_screen.dart';
...
Future<void> main() async {
  ...
  runApp(LandingScreen(Locale(pref.defaultLanCode, pref.defaultLan)));
}
