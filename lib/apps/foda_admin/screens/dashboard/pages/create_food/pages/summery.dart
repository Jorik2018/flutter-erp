    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              SummeryTextCard(title: "Title", text: state.titleController.text),
              const SizedBox(width: AppTheme.cardPadding),
              SummeryTextCard(title: "Category", text: state.seletedCategory!),
            ],
          ),
          ...
          Row(
            children: [
              ...
              Text("Set Live", style: Theme.of(context).textTheme.titleSmall),
            ],
          ),
          const SizedBox(height: AppTheme.cardPadding),
          Row(
            ...
            children: [
              FodaButton(
                title: "Previous",
                gradiant: const [AppTheme.blackLight, AppTheme.blackLight],
                onTap: () {
