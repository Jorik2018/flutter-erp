...
import 'package:flutter_erp/apps/video_watermark/models/VideoModel.dart';
import 'package:flutter_erp/apps/video_watermark/utils/DatabaseHelper.dart';
...
class VideoProvider with ChangeNotifier {
  ...
  Future<bool> save({
    ...
    var videoModel = VideoModel(
      ...
      "no",
      time,
      /**error:Too many positional arguments: 7 expected, but 8 found.
