...
import 'package:flutter_erp/apps/flutter_custom_path_drawer/screens/dashboard_screen.dart';
import 'package:flutter_erp/apps/flutter_custom_path_drawer/widgets/flat_button_widget.dart';
import 'package:flutter_erp/apps/flutter_custom_path_drawer/widgets/logo_widget.dart';
import 'package:flutter_erp/apps/flutter_custom_path_drawer/widgets/textform_field_widget.dart';
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: AnimatedBuilder(
                  ...
                  child: CustomPaint(painter: DrawTriangle(primaryColor)),
                ),
              ),
            ),
            Positioned(
              ...
              child: Container(
                ...
                child: AnimatedBuilder(
                  ...
                  child: CustomPaint(painter: DrawTriangle(Colors.white)),
                ),
              ),
            ),
            !_showForeground
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Icon(Icons.crop_square, size: 20, color: primaryColor),
