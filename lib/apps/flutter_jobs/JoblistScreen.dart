...
import 'package:flutter_erp/apps/flutter_jobs/CompanyCircle.dart';
import 'package:flutter_erp/apps/flutter_jobs/CustomDrawer.dart';
...
class JobListView extends StatefulWidget {
  const JobListView({Key? key, this.list}) : super(key: key);
  final List<Job>? list;
              ...
              return Padding(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    CircleCompanyLogo(company: item.company),
                  ],
                ),
              );
            }).toList()
...
class ClippedItem extends StatefulWidget {
  const ClippedItem({Key? key, required this.item}) : super(key: key);
        ...
        child: Card(
          ...
          child: InkWell(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Detail(widget.item!)),
              );
            },
            child: Padding(
