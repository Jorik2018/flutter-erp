...
import 'package:flutter_erp/apps/flutter_erp/domain/contact.dart';
...
class ContactRepositoryImpl implements ContactRepository {
  ...
  @override
  Future<bool> delete(Contact contact) => _contactDao.deleteById(
    ArgumentError.checkNotNull(contact.id, 'Contact id'),
  );
