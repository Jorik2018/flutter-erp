...
bool _isValidPhone(String phone) {
  final phoneRegExpString = r'^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$';

  return RegExp(phoneRegExpString, caseSensitive: false).hasMatch(phone);
}
...
class EditOrAddBloc {
  ...
  factory EditOrAddBloc(
    ...
    final genderController = BehaviorSubject<Gender>.seeded(
