  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<Contact?>(
        stream: bloc.contact$,
        initialData: bloc.contact$.valueOrNull,
                ...
                slivers: <Widget>[
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      title: Text(
                        contact == null ? 'Does not exist' : contact.name,
                      ),
    ...
    return SliverList(
      delegate: SliverChildListDelegate.fixed(<Widget>[
        ...
        ListTile(
          ...
          subtitle: Text(_dateFormat.format(contact.createdAt!)),
        ),
        ListTile(
          leading: Icon(Icons.update),
          title: Text('Updated at: '),
          subtitle: Text(_dateFormat.format(contact.updatedAt)),
        ),
