...
import 'package:flutter_erp/apps/green_taxi/model/card_model.dart';
import 'package:flutter_erp/apps/green_taxi/model/place_model.dart';
import 'package:flutter_erp/apps/green_taxi/model/ride_option_model.dart';
import 'package:flutter_erp/apps/green_taxi/ui/widgets/drawer_widget.dart';
import 'package:flutter_erp/apps/green_taxi/utils/constants.dart';
import 'package:flutter_erp/apps/green_taxi/utils/styles.dart';

import 'package:flutter_erp/apps/green_taxi/provider/google_map_service.dart';
...
class _BookTaxiPageState extends State<BookTaxiPage> {
  ...
  void _moveCamera(
    ...
    if (_toLocationController.text != null && _toPlaceDetail != null) {
      getLatLngBounds(
        LatLng(_fromplaceDetail.lat, _fromplaceDetail.lng),
          ...
          Positioned(
            ...
            child: _hasGottenCordinates
                ? GestureDetector(
                    ...
                    child: Icon(Icons.cancel, color: Colors.green, size: 40),
                  )
                : Text(""),
          ),
        ],
              ...
              TypeAheadField(
                ...
                builder: (context, controller, focusNode) => TextField(
                  ...
                  decoration: InputDecoration(
                    icon: Icon(FontAwesomeIcons.taxi.data, color: Colors.green),
        ...
        : Card(
            child: Container(
              ...
              child: ListTile(
                ...
                title: Text("Hello Dennis", style: CustomStyles.smallTextStyle),
                subtitle: Text(
      ...
      child: Card(
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Select Ride", style: CustomStyles.normalTextStyle),
              Container(
                height: 140,
                      ...
                      items: _cards.map((UserCardModel value) {
                        return new DropdownMenuItem<UserCardModel>(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Image.asset(value.imageUrl, height: 10),
                              Text(
                                value.cardNumber,
