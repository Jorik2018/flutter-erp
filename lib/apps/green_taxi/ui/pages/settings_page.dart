  ...
  _buildRowWidget(IconData iconData, String title, String subtitle) {
    return Row(
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            Icon(iconData, color: Constatnts.primaryColor),
            SizedBox(width: 20),
            Row(
              children: <Widget>[
                Column(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        SizedBox(height: 25),
                        _buildRowWidget(
                          FontAwesomeIcons.businessTime.data,
                          "Work",
                          "Density Inc",
                        ),
                        SizedBox(height: 25),
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text("Account Settings", style: CustomStyles.cardBoldTextStyle),
              ],
            ),
          ),
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text("Add New Plaace", style: CustomStyles.smallLightTextStyle),
              ],
            ),
          ),
        ],
