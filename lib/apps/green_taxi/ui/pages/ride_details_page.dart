  ...
  _buildRideInfo(String point, String title, String subtitle, Color color) {
    return Row(
      ...
      children: <Widget>[
        Column(
          children: <Widget>[
            Icon(FontAwesomeIcons.solidCircleDot.data, size: 12, color: color),
          ],
        ),
        SizedBox(width: 15),
        Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 3),
            Text(subtitle, style: CustomStyles.normalTextStyle),
          ],
        ),
      ],
    );
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      ListTile(
                        leading: Icon(
                          FontAwesomeIcons.moneyCheck.data,
                          color: Constatnts.primaryColor,
                          size: 30,
                        ),
                        title: Text(
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text("Ride Details", style: CustomStyles.cardBoldTextStyle),
              ],
            ),
          ),
        ],
