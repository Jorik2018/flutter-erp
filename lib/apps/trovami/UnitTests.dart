...
import 'package:flutter_erp/apps/trovami/managers/Groups2Manager.dart';
  ...
  void initializeFlutterFire() async {
    try {
      Firebase.initializeApp().then(
        (FirebaseApp app) => {onFirebaseInitialized()},
      );
    } catch (e) {
      setState(() {
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text("Groups", style: ThemeManager().getStyle(STYLE_TITLE)),
          ),
          Expanded(
            flex: 3,
    ...
    if (_errorInitializing) {
      return <Widget>[
        Text(
          ...
          style: ThemeManager().getStyle(STYLE_NORMAL_BOLD),
        ),
      ];
