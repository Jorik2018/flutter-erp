...
import 'package:flutter_erp/apps/trovami/helpers/CloudFirebaseHelper.dart';
import 'package:flutter_erp/apps/trovami/model/Group2.dart';
...
class Groups2Manager {
  ...
  Map<String, Group2> groups = Map<String, Group2>();
