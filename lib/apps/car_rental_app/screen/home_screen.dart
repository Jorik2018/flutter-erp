...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _rowButtons(),
              SizedBox(height: 15),
              _sliderWidgetCard(context),
              SizedBox(height: 15),
              _popularCarsHeadingWidget(),
              SizedBox(height: 15),
              _listCarWidgetHorizontal(context),
              SizedBox(height: 15),
            ],
          ),
        ),
        ...
        children: <Widget>[
          _navBarItem(
            ...
            selectedItemColor: _navBarPageSelector == 0
                ? Colors.red
                : Colors.white,
            selectedItemIconTextColor: _navBarPageSelector == 0
                ? Colors.white
                : Colors.red,
          ),
          _navBarItem(
            ...
            selectedItemColor: _navBarPageSelector == 1
                ? Colors.red
                : Colors.white,
            selectedItemIconTextColor: _navBarPageSelector == 1
                ? Colors.white
                : Colors.red,
          ),
          _navBarItem(
            ...
            selectedItemColor: _navBarPageSelector == 2
                ? Colors.red
                : Colors.white,
            selectedItemIconTextColor: _navBarPageSelector == 2
                ? Colors.white
                : Colors.red,
          ),
          _navBarItem(
            ...
            selectedItemColor: _navBarPageSelector == 3
                ? Colors.red
                : Colors.white,
            selectedItemIconTextColor: _navBarPageSelector == 3
                ? Colors.white
                : Colors.red,
          ),
        ],
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              height: 25,
              child: Image.asset(image, color: selectedItemIconTextColor),
            ),
            Text(
              title,
      ...
      child: Row(
        ...
        children: <Widget>[
          _rowButtonSingleItem(
            ...
            title: "HATCHBACK",
            selectedItemTextColor: _rowButtonController == 0
                ? Colors.red
                : Colors.black,
            selectedBgColor: _rowButtonController == 0
                ? Colors.red
                : Colors.white,
            selectedItemIconColor: _rowButtonController == 0
                ? Colors.white
                : Colors.red,
            onPressed: () {
              setState(() {
          ...
          _rowButtonSingleItem(
            ...
            title: "SEDAN",
            selectedItemTextColor: _rowButtonController == 1
                ? Colors.red
                : Colors.black,
            selectedBgColor: _rowButtonController == 1
                ? Colors.red
                : Colors.white,
            selectedItemIconColor: _rowButtonController == 1
                ? Colors.white
                : Colors.red,
            onPressed: () {
              setState(() {
          ...
          _rowButtonSingleItem(
            ...
            title: "SUV",
            selectedItemTextColor: _rowButtonController == 3
                ? Colors.red
                : Colors.black,
            selectedBgColor: _rowButtonController == 3
                ? Colors.red
                : Colors.white,
            selectedItemIconColor: _rowButtonController == 3
                ? Colors.white
                : Colors.red,
            onPressed: () {
              setState(() {
          ...
          _rowButtonSingleItem(
            ...
            title: "CROSSOVER",
            selectedItemTextColor: _rowButtonController == 4
                ? Colors.red
                : Colors.black,
            selectedBgColor: _rowButtonController == 4
                ? Colors.red
                : Colors.white,
            selectedItemIconColor: _rowButtonController == 4
                ? Colors.white
                : Colors.red,
            onPressed: () {
              setState(() {
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(
              ...
              child: Image.asset(image, color: selectedItemIconColor),
            ),
          ),
          SizedBox(height: 10),
          Text(
  ...
  Widget _sliderWidgetCard(BuildContext context) {
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          CarDetailPage(image: sliderData.sliderImage!),
                    ),
                  );
                },
                child: Card(
                        ...
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: FakeRepository.sliderData.map((
                                  sliderData,
                                ) {
                                  return Container(
                                    height: 7.0,
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color:
                                          _sliderIndex ==
                                              FakeRepository.sliderData.indexOf(
                                                sliderData,
                                              )
                                          ? Colors.red
                                          : Colors.black,
  ...
  Widget _listCarWidgetHorizontal(BuildContext context) {
    final width = MediaQuery.of(context).size.width;
      ...
      child: Card(
        child: PageView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _listViewItem(index, width);
          },
        ),
      ),
    );
  ...
  Widget _listViewItem(int index, double width) {
    return Stack(
      children: <Widget>[
        Column(
          children: <Widget>[
