        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 6.0),
                Text('390.874 views', style: Theme.of(context).textTheme!.bodySmall),
                SizedBox(height: 16.0),
                GestureDetector(
                  onTap: () => setState(() => expandDescription = !expandDescription),
                  child: Text(description, maxLines: expandDescription ? null : 2, overflow: TextOverflow.fade, style: Theme.of(context).textTheme.bodySmall)
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: ListTile(
              ...
              subtitle: Text('3M subscribers', style: Theme.of(context).textTheme.bodySmall),
              trailing: Material(
