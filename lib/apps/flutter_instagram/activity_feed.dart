  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Row(
            ...
            children: <Widget>[
              ...
              Flexible(
                child: Container(
                  child: Text(actionText, overflow: TextOverflow.ellipsis),
                ),
              ),
            ],
          ),
        ...
        Container(
          child: Align(
            child: Padding(child: mediaPreview, padding: EdgeInsets.all(15.0)),
      ...
      builder: (BuildContext context) {
        return Center(
          child: Scaffold(
            ...
            body: ListView(
              children: <Widget>[
                Container(child: ImagePostFromId(id: imageId)),
              ],
            ),
          ),
        );
