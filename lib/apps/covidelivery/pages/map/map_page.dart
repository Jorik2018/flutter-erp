import 'package:flutter_erp/apps/covidelivery/misc/palette.dart';
import 'package:flutter_erp/apps/covidelivery/misc/text_size.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        if (latLng != null)
          SizedBox.expand(
            /**error: The named parameter 'children' is required, but there's no corresponding argument.
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            if (msgSent)
                              MineChat(dateTime: '12:07', text: 'Grazie'),
                          ],
                        ),
                      ),
                      Divider(),
...
class OtherChat extends StatelessWidget {
  ...
  const OtherChat({Key? key, required this.text, required this.dateTime})
    : super(key: key);
          ...
          children: <Widget>[
            SizedBox.fromSize(
              ...
              child: Material(
                shape: CircleBorder(),
                clipBehavior: Clip.antiAlias,
                child: Image.asset('res/pizio.jpeg', fit: BoxFit.cover),
              ),
            ),
            SizedBox(width: 12.0),
            Expanded(
...
class MineChat extends StatelessWidget {
  ...
  const MineChat({Key? key, required this.text, required this.dateTime})
    : super(key: key);
