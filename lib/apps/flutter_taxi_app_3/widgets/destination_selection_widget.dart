...
import 'package:flutter_erp/apps/flutter_taxi_app_3/controllers/user_location_controller.dart';
    ...
    return isLoading
        ...
        : AnimatedBuilder(
            ...
            builder: (context, child) {
              ...
              return Container(height: 150 * animation.value, child: child);
            },
            child: Container(
              height: 150.0,
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleSmall!.copyWith(fontSize: 12.0),
            ),
          ],
        ),
      ),
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              padding: EdgeInsets.all(8.0),
              child: Icon(Icons.my_location, size: 22.0, color: Colors.white),
            ),
            SizedBox(height: 12.0),
            Text("New Ride", style: Theme.of(context).textTheme.titleMedium),
            SizedBox(height: 4.0),
            Text(
              "Select Dest.",
              style: Theme.of(
