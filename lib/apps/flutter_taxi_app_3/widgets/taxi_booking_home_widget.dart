...
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/loading_shimmer.dart';
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/taxi_booking_details_widget.dart';
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/taxi_booking_not_confirmed_widget.dart';
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/taxi_booking_payments_widget.dart';
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/taxi_booking_state_widget.dart';
import 'package:flutter_erp/apps/flutter_taxi_app_3/widgets/taxi_booking_taxis_widget.dart';
                        ...
                        child: BlocBuilder<TaxiBookingBloc, TaxiBookingState>(
                          builder: (context, currentState) {
                            switch (currentState.runtimeType) {
                              ...
                              default:
                                return Center(child: Text("Not Initialized"));
                            }
                          },
                        ),
                      ),
