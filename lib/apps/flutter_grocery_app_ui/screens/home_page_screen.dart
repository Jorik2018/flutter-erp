...
import 'package:flutter_erp/apps/flutter_grocery_app_ui/widgets/categories_tile.dart';
import 'package:flutter_erp/apps/flutter_grocery_app_ui/widgets/top_product_tile.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          /**The getter 'lingripLines' isn't defined for the type 'FontAwesomeIcons'.
Try importing the library that defines 'lingripLines', correcting the name to the name of an existing getter, or defining a getter or field named 'lingripLines'. */
          icon: Icon(FontAwesomeIcons.gripLines.data),
          onPressed: () {},
          color: Colors.grey,
          tooltip: 'Menu',
        ),
