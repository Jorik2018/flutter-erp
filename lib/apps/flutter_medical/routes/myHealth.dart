...
class _MyHealthPageState extends State<MyHealthPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 250), () {
      print('here');
      setState(() {
        UserProfile.userHealthScore = userProfileSnapshot!.docs[0]
        ...
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return userProfileCard(
                ...
                imagePath: userProfileSnapshot!.docs[index].data()["imagePath"],
                age: userProfileSnapshot!.docs[index].data()["age"],
                dob: userProfileSnapshot!.docs[index].data()["dob"],
                firstName: userProfileSnapshot!.docs[index].data()["firstName"],
                lastName: userProfileSnapshot!.docs[index].data()["lastName"],
                gender: userProfileSnapshot!.docs[index].data()["gender"],
                language: userProfileSnapshot!.docs[index].data()["language"],
                bmi: userProfileSnapshot!.docs[index].data()["bmi"],
                userHealthScore:
                    (userProfileSnapshot!.docs[index].data()["userHealthScore"])
                        .toDouble(),
                heightFeet: userProfileSnapshot!.docs[index]
                    .data()["heightFeet"],
                heightInch: userProfileSnapshot!.docs[index]
                    .data()["heightInch"],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child: loadUserProfile()),
    );
  }
}
