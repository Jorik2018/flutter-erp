...
import 'package:flutter_erp/apps/flutter_medical/routes/imageGallery.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  QuerySnapshot<Map<String, dynamic>>? doctorProfileSnapshot;
  QuerySnapshot<Map<String, dynamic>>? doctorOfficeSnapshot;
    ...
    return doctorProfileSnapshot != null
        ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              return doctorCard(
                firstName: doctorProfileSnapshot!.docs[index]
                    .data()["firstName"],
                lastName: doctorProfileSnapshot!.docs[index].data()["lastName"],
                prefix: doctorProfileSnapshot!.docs[index].data()["prefix"],
                specialty: doctorProfileSnapshot!.docs[index]
                    .data()["specialty"],
                imagePath: doctorProfileSnapshot!.docs[index]
                    .data()["imagePath"],
                rank: doctorProfileSnapshot!.docs[index].data()["rank"],
                medicalEducation: doctorProfileSnapshot!.docs[index]
                    .data()["medicalEducation"],
                residency: doctorProfileSnapshot!.docs[index]
                    .data()["residency"],
                internship: doctorProfileSnapshot!.docs[index]
                    .data()["internship"],
                fellowship: doctorProfileSnapshot!.docs[index]
                    .data()["fellowship"],
                biography: doctorProfileSnapshot!.docs[index]
                    .data()["biography"],
              );
            },
          )
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          alignment: Alignment.center, // where to position the child
          child: Column(children: [doctorProfile()]),
        ),
      ),
    );
  }
