...
import 'package:flutter_erp/apps/flutter_medical/routes/functions.dart';
import 'package:flutter_erp/apps/flutter_medical/services/shared_preferences.dart';
import 'package:flutter_erp/apps/flutter_medical/widgets.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  QuerySnapshot<Map<String, dynamic>>? userProfileSnapshot;
    ...
    if (lastDocument == null) {
      ...
      databaseMethods
          ...
          .then((val) {
            setState(() {
              doctorSnapshot = val;
              print("pulling doctors, lastDocuments is:");
              print(lastDocument);
              setState(() {
                isLoading = false;
              });
              ...
              children: [
                Container(
                  child: Stack(
                    ...
                    children: [
                      Container(
                        margin: const EdgeInsets.only(top: 5.0, bottom: 12.5),
                        child: Image.network(
                          specialtyImagePath!,
                          height: 60,
                          width: 60,
  ...
  viewDoctorProfile({required lastName}) {
                              ...
                              MaterialButton(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          MyHealthPage(UserProfile.userEmail),
                                    ),
                                  );
                                },
                                color: Theme.of(context).primaryColor,
