...
class _CategoryPageState extends State<CategoryPage> {
  ...
  Widget specialtyCard({String? specialtyName, String? specialtyDescription}) {
    return Container(
      child: Text(
            ...
            searchSnapshot != null
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return doctorCard(
                        context: context,
                        firstName: searchSnapshot!.docs[index]
                            .data()["firstName"],
                        lastName: searchSnapshot!.docs[index]
                            .data()["lastName"],
                        prefix: searchSnapshot!.docs[index].data()["prefix"],
                        specialty: searchSnapshot!.docs[index]
                            .data()["specialty"],
                        rank: searchSnapshot!.docs[index].data()["rank"],
                        imagePath: searchSnapshot!.docs[index]
                            .data()["imagePath"],
                      );
                    },
                  )
