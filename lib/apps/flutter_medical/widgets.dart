...
import 'package:flutter_erp/apps/flutter_medical/main.dart';
import 'package:flutter_erp/apps/flutter_medical/database.dart';
import 'package:flutter_erp/apps/flutter_medical/routes/myHealth.dart';
import 'package:flutter_erp/apps/flutter_medical/routes/search.dart';
import 'package:flutter_erp/apps/flutter_medical/routes/category.dart';
import 'package:flutter_erp/apps/flutter_medical/routes/profile.dart';
import 'package:flutter_erp/apps/flutter_medical/routes/createProfile.dart';
import 'package:flutter_erp/apps/flutter_medical/models/userProfile.dart';
import 'package:flutter_erp/apps/flutter_medical/services/authenticate.dart';
import 'package:flutter_erp/apps/flutter_medical/services/authentication.dart';
...
class _GlobalDrawerState extends State<GlobalDrawer> {
  ...
  QuerySnapshot<Map<String, dynamic>>? specialtySnapshot;
  ...
  Widget specialtyDrawerItem({
    ...
    return ListTile(
      leading: Image.network(specialtyImagePath!, height: 25, width: 25),
      title: Row(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => CategoryPage(specialtyName)),
        );
      },
    );
  }
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MyHealthPage(UserProfile.userFirstName),
                ),
              );
            },
          ),
...
class StarRating extends StatelessWidget {
  ...
  Widget buildStar(
    ...
    Icon icon;
    if (rank >= rating) {
      return icon = Icon(Icons.star_border);
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefix: Padding(
          ...
          child: Text(hintText!, style: TextStyle(fontWeight: FontWeight.bold)),
        ),
      ),
      validator: (value) {
        if (value!.isEmpty) {
...
Widget customTextField(context, String hintText, IconData icon) {
  return TextField(
    decoration: InputDecoration(
      hintText: hintText,
      hintStyle: TextStyle(color: Color(0xFFb1b2c4)),
      ...
      prefixIcon: Icon(icon, color: Color(0xFF6aa6f8)),
      //
    ),
      ...
      child: Container(
        ...
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(coverageIcon, size: 35),
              Container(
                margin: const EdgeInsets.only(top: 7.5),
                child: Text(coverageName, style: TextStyle(fontSize: 13)),
              ),
            ],
          ),
        ),
