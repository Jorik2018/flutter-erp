  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Colors.white,
        boxShadow: [
          BoxShadow(color: Colors.indigo[200]!, spreadRadius: 1, blurRadius: 5),
        ],
      ),
        ...
        child: Column(
          ...
          children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Icon(Icons.local_offer, color: Colors.grey, size: 22),
                        SizedBox(width: 12),
                        Text(
                          eventOfferText!,
                          style: TextStyle(
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                Icon(Icons.location_on, color: Colors.indigo, size: 26),
                SizedBox(width: 12),
                Text(
                  eventVenue!,
                  style: TextStyle(
