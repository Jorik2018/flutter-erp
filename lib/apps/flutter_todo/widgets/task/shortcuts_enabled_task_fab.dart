...
class ShortcutsEnabledTaskFab extends ConsumerStatefulWidget {
  const ShortcutsEnabledTaskFab({super.key});

  @override
  ConsumerState<ShortcutsEnabledTaskFab> createState() =>
      _ShortcutsEnabledTaskFabState();
}

class _ShortcutsEnabledTaskFabState
    extends ConsumerState<ShortcutsEnabledTaskFab>
  ...
  void _createTodo(Priority priority) {
    ...
    todoNotifier.setCurrent(
      Task(title: '', userId: user.id!, priority: priority),
    );
