...
import 'package:flutter_erp/apps/tourism_demo/ui/destinations/destinations_page.dart';
            ...
            new TextButton(
              ...
              onPressed: () {
                ...
                if (store.state.appLocale == AppState.arLocale) {
                  store.dispatch(
                    ChangeLanguageAction(locale: AppState.enLocale),
                  );
                } else {
                  store.dispatch(
                    ChangeLanguageAction(locale: AppState.arLocale),
                  );
                }
              },
            ),
