...
import 'package:flutter_erp/apps/gettaxi/styles/styles.dart';
import 'package:flutter_erp/apps/gettaxi/widgets/brand_divider.dart';
        ...
        child: Drawer(
          child: ListView(
            ...
            children: [
              ...
              BrandDivider(),
              ListTile(
                leading: Icon(FontAwesomeIcons.gift.data),
                title: Text("Passeios Gratuitos", style: kDrawerItemStyle),
              ),
              ListTile(
                leading: Icon(FontAwesomeIcons.creditCard.data),
                title: Text("Pagamentos", style: kDrawerItemStyle),
              ),
              ListTile(
                leading: Icon(FontAwesomeIcons.clockRotateLeft.data),
                title: Text("Historico do Passeio", style: kDrawerItemStyle),
              ),
              ListTile(
                leading: Icon(FontAwesomeIcons.supportnow.data),
