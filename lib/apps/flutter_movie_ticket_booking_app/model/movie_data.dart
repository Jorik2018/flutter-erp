  ...
  MovieData() {
    ...
    movieList.add(
      MovieModel(
        ...
        castList: [
          MovieCastModel(
            name: "Liu Yifei",
            photo: Image.asset("assets/images/cast/liu.jpg"),
          ),
          MovieCastModel(
            name: "Donnie Yen",
            photo: Image.asset("assets/images/cast/donnie.jpg"),
          ),
          MovieCastModel(
            name: "Jet Li",
            photo: Image.asset("assets/images/cast/jetli.jpg"),
          ),
          MovieCastModel(
            name: "Gong Li",
            photo: Image.asset("assets/images/cast/gongli.jpg"),
          ),
        ],
      ),
    );
    movieList.add(
      MovieModel(
        ...
        image: Image.asset("assets/images/blackwidow.jpg"),
        imageText: Image.asset("assets/images/blackwidow-text.png"),
        videoClipPath: "assets/videos/blackwidowclip.mp4",
        videoClipReflectionPath: "assets/videos/blackwidowclip-reflection.mp4",
        castList: [
          MovieCastModel(
            name: "Scarlett Johansson",
            photo: Image.asset("assets/images/cast/scarlett.jpg"),
          ),
          MovieCastModel(
            name: "Florance Pugh",
            photo: Image.asset("assets/images/cast/florance.jpg"),
          ),
          MovieCastModel(
            name: "David Harbour",
            photo: Image.asset("assets/images/cast/david.jpg"),
          ),
          MovieCastModel(
            name: "Rachel Weisz",
            photo: Image.asset("assets/images/cast/rachel.jpg"),
          ),
        ],
      ),
    );
