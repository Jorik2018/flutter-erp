...
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/common/color_constants.dart';
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/widgets/app_widget.dart';
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/widgets/text_button_widget.dart';
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/widgets/video_clipper.dart';
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/widgets/video_clipper2.dart';
...
class _BookingScreenState extends State<BookingScreen>
  ...
  void initializeAnimation() {
    ...
    _reflectionTween = Tween<double>(
      begin: 0,
      end: 1,
    ).chain(CurveTween(curve: Curves.easeInOutQuart)).animate(_reflectionAc);
    ...
    _payButtonTween = Tween<double>(
      begin: -1,
      end: 0,
    ).chain(CurveTween(curve: Curves.easeInOutQuart)).animate(_payButtonAc);
    Future.delayed(Duration(milliseconds: 800), () {
          ...
          Positioned(
            ...
            child: ClipPath(
              ...
              child: AnimatedBuilder(
                animation: _reflectionAc,
                builder: (ctx, child) {
                  return Opacity(opacity: _reflectionTween.value, child: child);
                },
                child: Container(
                  height: 40,
                  width: MediaQuery.of(context).size.width * .8,
  ...
  Widget _timeSelector() {
    final time = <(String, int)>[('01.30', 45), ('06.30', 45), ('10.30', 45)];

    return Expanded(
      flex: 17,
      child: Container(
        margin: EdgeInsets.symmetric(vertical: _size.height * 0.035),
        child: ListView.builder(
          scrollDirection: Axis.horizontal,
          itemCount: time.length,
          itemBuilder: (ctx, index) {
            final (timeLabel, price) = time[index];
