...
import 'package:flutter_erp/apps/flutter_movie_ticket_booking_app/screens/booking_screen.dart';
...
class ItemDetailScreen extends StatefulWidget {
  ...
  ItemDetailScreen({required this.movie, required this.size});
...
class _ItemDetailScreenState extends State<ItemDetailScreen>
  ...
  void initState() {
    ...
    _moviePlayerController = VideoPlayerController.asset(
      widget.movie.videoClipPath!,
    )..initialize();
    _reflectionPlayerController = VideoPlayerController.asset(
      widget.movie.videoClipReflectionPath!,
    )..initialize();
  }
