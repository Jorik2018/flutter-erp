...
import 'package:flutter_erp/apps/fluter_uber_clone/helper/apiMethod.dart';
import 'package:flutter_erp/apps/fluter_uber_clone/models/directionDetails.dart';
import 'package:flutter_erp/apps/fluter_uber_clone/screens/Auth/login.dart';
import 'package:flutter_erp/apps/fluter_uber_clone/widget/Divider.dart';
import 'package:flutter_erp/apps/fluter_uber_clone/widget/progressdialog.dart';
...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Icon(
                              FontAwesomeIcons.moneyCheckDollar.data,
                              size: 18.0,
                              color: Colors.black54,
                            ),
                            SizedBox(width: 16.0),
  ...
  Future<void> getPlaceDirection() async {
    ...
    final List<PointLatLng> decodePolyLinePointsResult =
        PolylinePoints.decodePolyline(details!.encodedPoints!);

    pLineCordinates.clear();

    for (final PointLatLng pointLatLng in decodePolyLinePointsResult) {
