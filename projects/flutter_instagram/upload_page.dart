...
class _Uploader extends State<Uploader> {
  ...
  initPlatformState() async {
    Placemark first = await getUserLocation();
    setState(() {
      address = first;
    });
  }
              ...
              children: <Widget>[
                ...
                (address == null)
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Row(
                          children: <Widget>[
                            buildLocationButton(address!.name!),
                            buildLocationButton(address!.subLocality!),
                            buildLocationButton(address!.locality!),
                            buildLocationButton(
                              address!.subAdministrativeArea!,
                            ),
                            buildLocationButton(address!.administrativeArea!),
                            buildLocationButton(address!.country!),
                          ],
                        ),
                      ),
      ...
      return InkWell(
        ...
        child: Center(
          child: Container(
            ...
            child: Center(
              child: Text(locationName, style: TextStyle(color: Colors.grey)),
            ),
          ),
        ),
      );
