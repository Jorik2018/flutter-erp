...
class DatabaseInterface {
  ...
  Future<void> open() async {
    firebaseApp = await FirebaseApp.configure(
      ...
      options: const FirebaseOptions(
        clientID:
            "784157732504-upears5ba27c7r3qbmq7qhc6hkdm2jjl.apps.googleusercontent.com",
  ...
  Future addToPlaylist(List<Details> songs, String playlistName) {
    ...
    songs.forEach((song) {
      reference
          ...
          .set(song.toMap(), priority: -DateTime.now().millisecond);
    });
  ...
  Future addRecentSearch(dynamic data) {
    return reference
        ...
        .set(data.toMap(), priority: -DateTime.now().millisecond);
  }
