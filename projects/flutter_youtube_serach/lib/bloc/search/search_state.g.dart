...
class _$SearchState extends SearchState {
  ...
  @override
  final BuiltList<SearchItems> searchResult;
  @override
  final String error;
  @override
  ...
  _$SearchState._(
    ...
    if (searchResult == null) {
      throw new BuiltValueNullFieldError('SearchState', 'searchResult');
    }
    if (error == null) {
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, isLoading.hashCode), searchResult.hashCode),
            error.hashCode),
...
class SearchStateBuilder implements Builder<SearchState, SearchStateBuilder> {
  ...
  ListBuilder<SearchItems> _searchResult;
  ListBuilder<SearchItems> get searchResult =>
      _$this._searchResult ??= new ListBuilder<SearchItems>();
  set searchResult(ListBuilder<SearchItems> searchResult) =>
