        ...
        case 'items':
          result.items.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(VideoItems)]))
...
class _$YoutubeVideoResponse extends YoutubeVideoResponse {
  @override
  final BuiltList<VideoItems> items;
...
class YoutubeVideoResponseBuilder
  ...
  ListBuilder<VideoItems> _items;
  ListBuilder<VideoItems> get items =>
      _$this._items ??= new ListBuilder<VideoItems>();
  set items(ListBuilder<VideoItems> items) => _$this._items = items;
