        ...
        case 'items':
          result.items.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(SearchItems)]))
...
class _$YoutubeSearchResult extends YoutubeSearchResult {
  ...
  @override
  final BuiltList<SearchItems> items;
...
class YoutubeSearchResultBuilder
  ...
  ListBuilder<SearchItems> _items;
  ListBuilder<SearchItems> get items =>
      _$this._items ??= new ListBuilder<SearchItems>();
  set items(ListBuilder<SearchItems> items) => _$this._items = items;
