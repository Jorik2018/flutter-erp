...
return PopupMenuItem(child:StatefulBuilder(builder:(c,s)=>CheckboxListTile(
                title: Text(e['label']),
                value: e['visible'],
                onChanged: ((value) {
                  s(() {
      ...
      body: Column(
        children: [
          Flexible(
              ...
              ...layers.where((element) => element['visible']).map((e) {
                return TileLayer(
                  ...
                  wmsOptions: WMSTileLayerOptions(
                    transparent: true,
                    baseUrl:
                        'http://web.regionancash.gob.pe/geoserver/'+e['layer'].toString().split(':')[0]+'/wms?',
                    layers: [e['layer']],
                  ),
                  userAgentPackageName: 'dev.fleaflet.flutter_map.example',
                );
            ...
            nonRotatedChildren: [
              /*Container(width:200,decoration: BoxDecoration(color: Colors.white),
