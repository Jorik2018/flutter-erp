...
class ChildStartFragment extends StatefulWidget {
  ...
  @override
  _ChildStartFragmentState createState() => _ChildStartFragmentState();
}
...
class _ChildStartFragmentState extends State<ChildStartFragment> {
    ...
    Future.delayed(Duration.zero, () {
      ...
      if (widget.id != null) {
        ...
        Hive.openBox('app').then((box) {
          ...
          _getProvinces(fb.o['region']).then(
            (result) => {
              setState(() {
  ...
  Future _getProvinces(Object region) async {
    return (((await Hive.openBox('app')).get('provinces') ?? []) as List)
        .where(
          (element) => element['code'].toString().startsWith(region.toString()),
        )
        .toList();
  }
    ...
    List panels = [
      {
        ...
        'items': [
          ...
          Column(
            children: fb.radioGroup(['Masculino', 'Femenino'], 'p4', setState),
          ),
          Text("Fecha nacimiento", style: boldStyle),
          fb.dateField(context, 'birthday'),
          Text(
            "Tipo de seguro al que se encuentra afiliado/a",
            style: boldStyle,
          ),
          Column(
            children: fb.radioGroup(
              ['SIS', 'ESSALUD', 'FAP', 'PNP', 'Privado', 'No tiene seguro'],
              'insuranceType',
              setState,
            ),
          ),
          ...
          fb.dropdownButton(
            ...
            onChanged: (e) {
              _getProvinces(e != null ? e : '99').then(
                (result) => {
                  setState(() {
                    provinces = (result as List).toList();
                  }),
          ...
          if (fb.o['region'] != null && fb.o['region'] != '') ...[
            ...
            fb.dropdownButton(
              ...
              onChanged: (e) {
                _getDistricts(e != null ? e : '99').then(
                  (result) => {
                    setState(() {
      ...
      },
      {
        ...
        'items': [
          ...
          Text(
            "¿Cuenta con un número de celular de contacto?",
            style: boldStyle,
          ),
      ...
      },
      {
        ...
        'items': [
          ...
          Text(
            "¿Cuántas habitaciones usan en su hogar sólo para dormir?",
            style: boldStyle,
          ),
          fb.numberField('p37'),
          ...
          fb.numberField('p38'),
          Text(
            "¿Cuántos miembros del hogar tienen menos de 5 años?",
            style: boldStyle,
          ),
          Text("Niños:"),
          ...
          Column(
            children: fb.radioGroup(
              ...
              addWidget: (widgets, value, index) => {
                if (index == 2 &&
                    (value != null && value.toString() == 'Otro (especifique)'))
                  {
                    widgets.add(
                      TextFormField(
                        minLines: 1,
          ...
          ...("o['p45']" == 'Si'
              ...
              : []),
          Text(
            "¿Algún miembro del hogar presenta algún tipo de discapacidad?",
            style: boldStyle,
          ),
      ...
      },
      {
        ...
        'items': [
          Text(
            "¿El niño/niña presenta algún tipo de discapacidad?",
            style: boldStyle,
          ),
      ...
      },
      {
        ...
        'items': [
          Text(
            "En estos momentos, ¿cuenta con la tarjeta CRED de su niño/a?",
            style: boldStyle,
          ),
          ...fb.radioGroup(
            [
          ...
          Text(
            "¿Tiene su control CRED al día, según su carnet?",
            style: boldStyle,
          ),
      ...
      },
      {
        ...
        'items': [
          ...
          Text(
            "¿En caso se haya realizado en otra institución, ¿dónde?",
            style: boldStyle,
          ),
          fb.textField('p63'),
          Text(
            "¿Cuál fue el valor obtenido? (valor ajustado por altura)",
            style: boldStyle,
          ),
          fb.numberField('p64'),
          Text(
            "¿Ha recibido sobres de sangrecita en el último mes?",
            style: boldStyle,
          ),
                ...
                children: [
                  ElevatedButton.icon(
                    onPressed: () {
                      ...
                      http2.post('/api/minsa/children', fb, state: this).then((
                        response,
                      ) {
                        setState(() {
