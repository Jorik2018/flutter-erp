...
//            ),
  ...
  Widget _buildTripDate(BuildContext context) {
    DateTime? dateFrom = destination.dateFrom!=null?DateTime.parse(destination.dateFrom!):null;
    DateTime? dateTo = destination.dateTo!=null?DateTime.parse(destination.dateTo!):null;
