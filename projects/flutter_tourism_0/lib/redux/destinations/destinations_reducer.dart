...
DestinationsState _receivedDestinations(DestinationsState destinationsState, ReceivedDestinationsAction action) {
  return destinationsState.copyWith(loadingStatus: LoadingStatus.success, destinations: action.destinations);
}

DestinationsState _errorLoadingDestinations(DestinationsState destinationsState, ErrorLoadingDestinationsAction action) {
  return destinationsState.copyWith(loadingStatus: LoadingStatus.error, errorMessage: action.errorStr);
}
