...
class MakeAppointmentState extends State<MakeAppointment> {
  ...
  var randevuTarihi;
  var ElevatedButtonText = "Tıkla ve Seç";
          ...
          ElevatedButton(
            ...
            onPressed: () {
              _selectDate(context).then((result) => setState(() {
                    if (randevuTarihi == null) {
                      ElevatedButtonText = "Tıkla ve Seç";
                      tarihSecildiMi = false;
                    } else {
                      ElevatedButtonText =
                  ...
                  if (docs.docs.isNotEmpty) {
                    for (var i = 0; i < docs.docs.length; i++) {
                      ActiveAppointment rand =
                          ActiveAppointment.fromMap(docs.docs[i].data as Map<String, dynamic>);
